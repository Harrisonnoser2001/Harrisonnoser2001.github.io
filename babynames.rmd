...
# turn of echo, warning, and message so that they don't show up
...
Counts of the number of males and females born (and registered!) in 1880
...
```{r, names_over_time, fig.cap="A Caption"}
# plot some counts -----
